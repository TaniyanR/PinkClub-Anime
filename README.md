...
アニメ動画の商品検索・一覧・詳細表示に特化した構成です。

## 主な機能

- FANZA Affiliate APIの商品取得・保存
- 複数フロアの順次取得とフロア別offset管理
- トップ、検索、詳細、ランキング、タグ、関連記事
- ジャンル、メーカー、レーベル、シリーズ、作者の関連ページ
- WordPress風の管理画面
- API認証情報の保存、10件テスト取得、商品cron自動取得
...
```bash
php /path/to/PinkClub-Anime/scripts/auto_import.php
```
